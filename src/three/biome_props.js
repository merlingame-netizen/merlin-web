...
const PROP_CONFIGS = {
  broceliande: [
    ...
    { type: 'flower', count: 400, spread: 75, scaleMin: 0.3, scaleMax: 1.0, color: 0x9966cc },
    { type: 'flower', count: 250, spread: 70, scaleMin: 0.3, scaleMax: 0.8, color: 0xddaa44 },
    { type: 'mushroom', count: 250, spread: 65, scaleMin: 0.3, scaleMax: 1.0, color: 0xcc8844 },
    { type: 'mushroom', count: 100, spread: 50, scaleMin: 0.5, scaleMax: 1.4, color: 0xaa6633 },
    { type: 'grass_patch', count: 3000, spread: 85, scaleMin: 0.5, scaleMax: 1.5, color: 0x5aaa44 },
    { type: 'grass_patch', count: 2000, spread: 75, scaleMin: 0.3, scaleMax: 0.8, color: 0x78bb55 },
    { type: 'tall_grass', count: 800, spread: 80, scaleMin: 0.6, scaleMax: 1.3, color: 0x66aa44 },
    { type: 'fern', count: 150, spread: 55, scaleMin: 0.4, scaleMax: 0.8, color: 0x4a9a44 },
